...
entite_sec entite_initialiser3(int pics,entite_sec entite,char schema[50],int y)
{
int i;
char entitee[50];
entite.pics=pics;

entite.rect.x=rand()%2400+4800;
...
int entite_afficher2(SDL_Surface *screen,entite_sec entite,SDL_Rect camera,int i,int vitesse)
{ 
entite.rect.x=entite.rect.x+vitesse;
if(entite.rect.x<=900)//0
entite.rect.x=6000;
else if(entite.rect.x>=6000)
{entite.rect.x=900;//0
entite.rect.x-=1000;}
